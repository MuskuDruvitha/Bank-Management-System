...
public class Signup2 extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (!pan.matches("\\d{10}")) {
            JOptionPane.showMessageDialog(null, "PAN Number must be exactly 10 digits and contain only numbers.");
            return;
        }

       
        if (!aadhar.matches("\\d{12}")) {
            JOptionPane.showMessageDialog(null, "Aadhar Number must be exactly 12 digits and contain only numbers.");
            return;
        }
